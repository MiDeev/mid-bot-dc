...
public class IdeaAnswerHandler extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        if (!event.getChannel().asTextChannel().getId().equals("979498476452859994") || !event.getMember().getId().equals("421259943123877888"))
            return;
        ...
        privateChannel.sendMessageEmbeds(
                new EmbedBuilder()
                        ...
                        .setColor(Color.decode("0x96ff3c"))
                        .addField("Ваша идея для " + ideaType + ":",
                                IDEA_PATTERN.matcher(Objects.requireNonNull(embed.getDescription()))
                                        .replaceAll("")
                                        .replaceFirst("\n", "")
                                        .replaceFirst("\n", ""), false)

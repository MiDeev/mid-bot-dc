...
public class Information extends ListenerAdapter {
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        if (event.getChannel().getId().equals("942520425936719952") && event.getMessage().getContentDisplay().equals("info")) {
            ...
            si.setDescription(
                    "<#988419768757420063>  - правила сервера.\n" +
                            ...
                            "<#989613511124590662> - список изменений, связанных с сервером.\n" +
                            ...
                            "<#1109502097914863667> - ваши идеи для YouTube-канала MiDeev'a.\n" +
        ...
        if (event.getChannel().getId().equals("942520425936719952") && event.getMessage().getContentDisplay().equals("info")) {
            ...
            si.setDescription(
                    "<@&942440874690871316> - **ваш серверный брат, он же <@421259943123877888>**.\n" +
                            "\n" +
                            ...
                            "*Главный помощник администратора и по персоналу сервера.*\n" +
                            "<@&975748559838281798> - **отвечает за порядок на сервере.**\n" +
                            "*Является доверенным лицом куратора и отвечает за контролов.*\n" +
                            "<@&975748559473344532> - **следит за чатом и не даёт нарушать правила.**\n" +
                            "*Увидев нарушение, пингуйте роль или пишите им в ЛС.*\n" +
                            "<@&1121401763778539691> - **главный навигатор по серверу.**\n" +
                            "*Знают всё о сервере и могут ответить на всё, что с ним связано.*\n" +
                            "\n" +
                            "<@&975750629425315862> - **тот же администратор, но технический.**\n" +
                            "*Помогает разрабатывать главного помощника сервера - <@985616767328067585>*\n" +
                            "\n" +
                            "<@&943220825753022525> - ** как BRO, только BROOST!** [*бустер сервера*].\n" +
                            "*Имеет возможности лучше чем у роли <@&975318500648304650>.*\n" +
                            "\n" +
                            "<@&975322744050831390> - **имеет доступ к журналу аудита.**\n" +
                            ...
                            "<@&975318500648304650> - **открывает доступ к каналу <@&943220825753022525>.**\n" +
                            "*Выдаётся при достижении **50**-го уровня.*\n" +
                            "<@&975318511549300776> - **разрешает создавать ветки в чате.**\n" +
                            ...
                            "<@&975837708972855326> - **даёт пользоваться командой /__xpleaders__.**\n" +

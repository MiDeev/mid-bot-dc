...
public class TestCommand extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        if (event.getChannel().getId().equals("942520425936719952") && event.getMessage().getContentDisplay().equals(".test")) {
            ...
            emba.setDescription("**Правила сервера, обязательные к прочтению:**\n" +
                    ...
                    "            **__Пункт №1. Общение__**\n" +
                    "            \n" +
                    "            `1.1` Мат в любом виде на сервере ЗАПРЕЩЁН.\n" +
                    "            \n" +
                    "            `1.2` Оскорбление и провоцирование на агрессию ЗАПРЕЩЕНЫ.\n" +
                    "            \n" +
                    "            `1.3` Флуд от 3x и более одинаковых сообщений ЗАПРЕЩЕН.\n" +
                    "            \n" +
